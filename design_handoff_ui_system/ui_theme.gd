...
const FONT_REGULAR := "res://ui/fonts/PixelOperator8.ttf"
const FONT_BOLD    := "res://ui/fonts/PixelOperator8-Bold.ttf"
const FONT_DISPLAY := "res://ui/fonts/Silkscreen-Regular.ttf"
